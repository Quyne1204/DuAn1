                ...
                <div class="wrapper-table" style="margin-top: 0px;">
                    ...
                    <table class="table-inform">
                        ...
                        <thead >
                            ...
                            <td width="140px">Ảnh</td>
                            <td width="140px">Đơn giá</td>
                            <td width="140px">Ngày thêm</td>
                            <td width="160px">Đã bán</td>
                            <td width="350px">Chi tiết sản phẩm</td>    
                            <td  width="20px"  >Công cụ</td>
                        </thead>
