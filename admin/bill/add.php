<div class="container flex">
            ...
            <?php
                foreach ($list_sp as $sanpham) {
                    ...
                    echo '
                        <tbody>
                            <td>'.$products_name.'</td>
                            <td><img width="100px" style="padding-bottom:20px" src="../images/sanpham/'.$img.'"></td>
                            <td>'.$money.'</td>
                            <td>
                                <form action="index.php?act=addtocart" method="POST" style="width:100%"> 
                                    ...
                                    <input name="addtocart" id="chon" type="submit" value="Chọn">
                                </form>
                            </td>
                        </tbody>
                        ';
    ...
    <div class="dropdown">
        <a href="index.php?act=add_cart" class="cart1 flex">
            <span>
                    ...
                    foreach ($_SESSION['admincart'] as $cart) {
                        echo'
                            <div class="flex" style="margin-top: 5px;">
                                <img style="margin-left: 10px;margin-top:20px;" width="50px" height="50px" src="../images/sanpham/'.$cart[2].'">
                                <div style="margin-left: 10px;">
                                    <p style="font-weight: bold;">'.$cart[1].'</p>
                                    <p>'.$cart[3].'</p>
                                </div>
                            </div>
                        ';}
