        ...
        <form method="POST" action="index.php?act=signup">
            ...
            <div class="form-model">
                ...
                <div class="field flex">
                    <input class="form-input" id="input" type="password" name="password" placeholder="Mật khẩu..." required>
                ...
                <!-- <div class="form-control">
                    <label class="form-title">Số điện thoại</label>
                    <input class="form-input" type="number" name="user_name" placeholder="Số điện thoại..." required>
                </div>

                <div class="form-control">
                    <label class="form-title">Địa chỉ</label>
                    <input class="form-input" type="text" name="user_name" placeholder="Địa chỉ..." required>
                </div> -->
